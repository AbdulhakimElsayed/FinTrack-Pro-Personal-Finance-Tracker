...
|---------------------|----------------|------------------|
| ![Dashboard](assets/screenshots/dashboard.jpg) | ![Budget Overview](assets/screenshots/budget_overview.jpg) | ![Transaction List](assets/screenshots/transaction_list.jpg) |
| **Category Budgets** | **Analytics** | **Spending Trends** |
| ![Category Budgets](assets/screenshots/category_budgets.jpg) | ![Analytics](assets/screenshots/analytics.jpg) | ![Spending Trends](assets/screenshots/spending_trends.jpg) |
